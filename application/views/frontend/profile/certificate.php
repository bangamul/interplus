			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div id="section-home" class="heading-block text-center border-bottom-0 page-section">
						...
						<span>PT. Hogan Gailang Interplus</span>
						<img class="statusveri mb-3" src="<?= base_url(); ?>assets/images/verified.png" alt="hgi" loading="lazy" decoding="async">

						<div class="table-responsive w70">
							<table class="table table-bordered mb-0 text-left">
								<tbody>
									<tr>
										<td>Certificate Number</td>
										<td><h2>517-QR-220615</h2></td>
									</tr>
									<tr>
									...
									<tr>
										<td>Company</td>
										<td>PT. Sumsang Indonesia</td>
									</tr>
									<tr>
										<td>Address</td>
										<td>Jakarta, Jl. Bambu Kuning No.6, RT.2/RW.2, Bambu Apus, Kec. Cipayung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13890</td>
									</tr>
									<tr>
										<td>Scope of Certification</td>
										<td>Dummy text Scope Description</td>
									</tr>
									<tr>
										<td>EA Code</td>
										<td>28</td>
									...
									<tr>
										<td>Initial Assesment Date</td>
										<td>27 May 2022</td>
									</tr>
									<tr>
										<td>Certification Granting Date</td>
										<td>15 June 2022</td>
									</tr>
									<tr>
