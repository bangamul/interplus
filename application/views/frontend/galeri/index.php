...
<head>
  ...
  <link rel="preload" href="https://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Poppins:300,400,500,600,700|PT+Serif:400,400i&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
	<noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Poppins:300,400,500,600,700|PT+Serif:400,400i&display=swap"></noscript>
          ...
          <div class="header-row justify-content-center">
            ...
            <nav class="primary-menu">
              ...
              <ul class="menu-container">
                ...
                <li class="menu-item current"><a class="menu-link" href="<?= site_url('galeri'); ?>"><div>Galeri</div></a></li>
        ...
        <div class="position-relative bg-light">
          ...
          <div class="container">
            <div class="row gutter-50 pb-4" data-lightbox="gallery">
              <div class="col-md-6">
                <a href="<?= base_url(); ?>assets/images/gallery-7/1.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/1.jpg" alt="Gallery Thumb 1"></a>
              </div>
              <div class="col-md-6">
                <a href="<?= base_url(); ?>assets/images/gallery-7/2.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/2.jpg" alt="Gallery Thumb 2"></a>
              </div>
              <div class="col-12">
                <a href="<?= base_url(); ?>assets/images/gallery-7/6.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/6.jpg" alt="Gallery Thumb 5"></a>
              </div>
              <div class="col-md-4">
                <a href="<?= base_url(); ?>assets/images/gallery-7/4.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/4.jpg" alt="Gallery Thumb 3"></a>
              </div>
              <div class="col-md-4">
                <a href="<?= base_url(); ?>assets/images/gallery-7/5.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/5.jpg" alt="Gallery Thumb 4"></a>
              </div>
              <div class="col-md-4">
                <a href="<?= base_url(); ?>assets/images/gallery-7/3.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/3.jpg" alt="Gallery Thumb 5"></a>
              </div>
              <div class="col-md-6">
                <a href="<?= base_url(); ?>assets/images/gallery-7/7.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/7.jpg" alt="Gallery Thumb 5"></a>
              </div>
              <div class="col-md-6">
                <a href="<?= base_url(); ?>assets/images/gallery-7/8.jpg" data-lightbox="gallery-item"><img src="<?= base_url(); ?>assets/images/gallery-7/8.jpg" alt="Gallery Thumb 5"></a>
              </div>
            </div>
          </div>
        </div>
