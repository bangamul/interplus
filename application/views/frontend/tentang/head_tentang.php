...
<head>
	...
	<link rel="preload" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700|Roboto:300,400,500,700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700|Roboto:300,400,500,700&display=swap"></noscript>
	...
	<link rel="preload" href="<?= base_url(); ?>assets/css/construction.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?= base_url(); ?>assets/css/construction.css"></noscript>
	<!-- / -->
    ...
    <noscript><link rel="stylesheet" href="<?= base_url(); ?>assets/css/font-icons.css"></noscript>
	...
	<link rel="preload" href="<?= base_url(); ?>assets/css/construction-fonts.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?= base_url(); ?>assets/css/magnific-popup.css"></noscript>
	...
	<link rel="preload" href="<?= base_url() ;?>assets/css/colors.php?color=F18052" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?= base_url() ;?>assets/css/colors.php?color=F18052"></noscript>

	<meta name="viewport" content="width=device-width, initial-scale=1" />

	<!-- <link rel="stylesheet" href="<?= base_url() ;?>assets/css/colors.php?color=F18052" type="text/css" /> -->
			...
			<div class="container">
				<div class="header-row">
					...
					<div id="logo" class="ms-auto ms-lg-0 me-lg-auto">
						<a href="index.html" class="standard-logo" data-dark-logo="<?= base_url(); ?>assets/images/logo-interplus.png"><img src="<?= base_url(); ?>assets/images/logo-interplus.png" alt="Interplus Logo" loading="lazy" decoding="async"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="<?= base_url(); ?>assets/images/logo-interplus.png"><img src="<?= base_url(); ?>assets/images/logo-interplus.png" alt="Interplus Logo" loading="lazy" decoding="async"></a>
					</div><!-- #logo end -->
					...
					<div class="header-misc d-none d-lg-flex">
						...
						<ul class="header-extras">
							...
							<li>
								...
								<div class="he-text">
									Email
									<span>info@interplus.co.id</span>
								</div>
							</li>
							<li>
								...
								<div class="he-text">
									We'are Open
									<span>Senin - Jum'at, 10.00 - 16 WIB</span>
								</div>
							</li>
						</ul>
				...
				<div class="container">
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row justify-content-lg-center">
						...
						<ul class="menu-container">
							<li class="menu-item "><a class="menu-link" href="<?= site_url() ;?>"><div>Beranda</div></a></li>
